---
description: Add comprehensive unit tests for the specified Python source code file. Example: `/add-test-for-module /path/to/music_bi_agent_poc/math_ops.py comprehensive "optional additional requirements"`
allowed-tools: Write(music_bi_agent_poc/**/*.py), Write(tests/**/*.py), Bash(.venv/bin/python tests/**/*.py)
---
