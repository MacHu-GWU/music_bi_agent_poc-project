...
### music_bi_agent_poc/auth/permissions.py
...
**Rendered as**: Configures components from `music_bi_agent_poc.auth.users` and `music_bi_agent_poc.auth.permissions` modules.
